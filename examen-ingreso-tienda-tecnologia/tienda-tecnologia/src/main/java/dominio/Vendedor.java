...
public class Vendedor {
	...
	public static final String SIN_PARAMETRO = "No se ha enviado el parametro nombre del cliente";
	...
	public void generarGarantia(String codigo, String nombreCliente) {
		...
		if (nombreCliente == null) {
			throw new GarantiaExtendidaException(SIN_PARAMETRO);
	 	} else if (totalVocales == 3) {
